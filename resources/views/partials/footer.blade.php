<footer class="main-footer">
  ...
  <!-- JS Libraies -->
  <script src="{{  secure_asset('node_modules/jquery-sparkline/jquery.sparkline.min.j') }}s"></script>
  <script src="{{  secure_asset('node_modules/chart.js/dist/Chart.min.j') }}s"></script>
  ...
  <script src="{{  secure_asset('node_modules/datatables/media/js/jquery.dataTables.min.js') }}"></script>
  <script src="{{  secure_asset('node_modules/datatables.net-bs4/js/dataTables.bootstrap4.min.js') }}"></script>
  <!-- Template JS File -->
  <script src="{{  secure_asset('assets/js/scripts.js') }}"></script>
  <script src="{{  secure_asset('assets/js/myscript.js') }}"></script>
